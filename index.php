...
<head>
    ...
    <meta name="description" content="Página incial do portal sobre a Música Brasileira">
        ...
        <div class="container">
          ...
          <header class="row">
            <div class="col-12 col-md-12 col-sm-12">
                ...
                <article class="row topo-home">
                  <div class="col-12">
                    <h1>Música Brasileira</h1>
                    <div class="col-10 offset-1">
                      <img src="images/home-top.jpg" class="img-fluid musica-brasileira img-mod" alt="Imagem de boas vindas da página com uma mulher com semblante feliz, ouvindo música" width="100%" height=>
              ...
              <article>
                ...
                <section class="row">
                    <div class="col-lg-4  col-md-6">
                      <h2>Axé</h2>
                      <img src="images/home-axe.jpg" class="img-fluid img-sec img-mod" alt="Um tambor com fundo em Marrom">
                      <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae modi ullam quaerat rerum voluptatem. Rem repellat quaerat nostrum debitis, excepturi, earum temporibus suscipit nemo minus dicta officiis commodi, libero itaque!</P>
                    ...
                    <div class="col-lg-4 col-md-6">
                      <h2>Rock</h2>
                      <img src="images/home-rock.jpg" class="img-fluid img-sec img-mod" alt="Uma Guitarra com fundo avermelhado">
                      <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae modi ullam quaerat rerum voluptatem. Rem repellat quaerat nostrum debitis, excepturi, earum temporibus suscipit nemo minus dicta officiis commodi, libero itaque!</P>
                    ...
                    <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-0 forro">
                      <h2>Forró</h2>
                      <img src="images/home-forro.jpg" class="img-fluid img-sec img-mod" alt="Uma sanfona com fundo alaranjado">
                      <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae modi ullam quaerat rerum voluptatem. Rem repellat quaerat nostrum debitis, excepturi, earum temporibus suscipit nemo minus dicta officiis commodi, libero itaque!</P>
                ...
                <section class="row justify-content-between">
                  <div class="col-lg-4 col-md-6">
                    <h2>Samba</h2>
                    <img src="images/home-samba.jpg" class="img-fluid img-sec img-mod" alt="Um pandeixo com fundo roxo">
                    <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae modi ullam quaerat rerum voluptatem. Rem repellat quaerat nostrum debitis, excepturi, earum temporibus suscipit nemo minus dicta officiis commodi, libero itaque!</P>
                  ...
                  <div class="col-lg-4 col-md-6 mpb">
                    <h2>Mpb</h2>
                    <img src="images/home-mpb.jpg" class="img-fluid img-sec img-mod" alt="Um violão com fundo amarelo">
                    <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae modi ullam quaerat rerum voluptatem. Rem repellat quaerat nostrum debitis, excepturi, earum temporibus suscipit nemo minus dicta officiis commodi, libero itaque!</P>
